...
export const skeletronPrime: SkeletronPrimeData = {
  ...
  combat: {
    ...
    coreStrategy: {
      title: "核心戰術",
      priority: '優先擊殺<span class="enemy-primary">雷射砲</span>與<span class="enemy-secondary">火砲</span>！',
      reason:
        '<span class="enemy-primary">雷射砲 (Prime Laser)</span> 和<span class="enemy-secondary">火砲 (Prime Cannon)</span> 是主要的遠程威脅來源。消滅它們後，剩下的電鋸和鉗子只能近戰，戰鬥會變得非常輕鬆。',
      steps: [
        '開戰後立即鎖定<span class="enemy-primary">雷射砲 (紅色)</span>集中火力',
        '雷射砲消滅後，轉而攻擊<span class="enemy-secondary">火砲 (橙色)</span>',
        '利用平台高度差閃避<strong>頭部衝撞</strong>',
        '避開頭部<strong>旋轉攻擊</strong>，此時它的傷害極高',
        '最後處理電鋸和鉗子，或直接攻擊頭部',
        '<strong>保持移動！停下來就是死！</strong>',
      ],
    },
  },
