...
export default {
  ...
  // 描述
  description: '射出的箭矢會從天空降落，搭配聖箭使用時效果極佳，是對付機械Boss的神器。',
  ...
  // 推薦理由
  whyGood: '搭配聖箭使用時，每支箭矢落地時會額外召喚 2 顆落星。對付毀滅者這類長條型多段體 Boss 時，大量的落星能夠同時命中多個體節，造成毀滅性的傷害。是困難模式初期最強的遠程武器之一。',
  ...
  tips: [
    {
      title: '聖箭搭配',
      content: '必須使用聖箭才能發揮最大威力。聖箭需要用獨角獸角和妖精塵製作。',
    },
    {
      title: '天空競技場',
      content: '建議在天空建造戰鬥平台，讓箭矢有足夠的落下空間。',
    },
    {
      title: '對付毀滅者',
      content: '這是對付毀滅者的最佳武器。大量落星可以同時命中多個體節，幾乎可以秒殺。',
    },
  ],
}
