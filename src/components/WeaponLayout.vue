...
<template>
  <DocLayout title="本頁目錄">
    ...
    <!-- ========================================
         ...
         ======================================== -->
      <section v-if="weapon.mechanics" class="smart-card">
        <!-- Header: 身份與代價 -->
        <header class="smart-card__header">
          ...
          <div class="smart-card__cost">
            <span 
              v-if="weapon.mechanics.resource?.manaCost" 
              class="cost-pill cost-pill--mana"
            >
              💧 {{ weapon.mechanics.resource.manaCost }} Mana
            </span>
            <span 
              v-if="weapon.mechanics.resource?.ammo" 
              class="cost-pill cost-pill--ammo"
            >
              🎯 {{ weapon.mechanics.resource.ammo.type }}
              <template v-if="weapon.mechanics.resource.ammo.saveChance === 100">∞</template>
            </span>
          </div>
        </header>
        ...
        <div class="smart-grid">
          ...
          <!-- 左下：彈道物理 -->
          <div class="smart-module smart-module--projectile">
            <div class="smart-module__header">
            ...
            <div class="smart-module__tags">
              ...
              <span 
                v-else-if="weapon.mechanics.projectile?.piercing > 0" 
                class="smart-tag smart-tag--info"
              >
          ...
          >
            ...
            <div v-if="weapon.mechanics.combat?.trueMelee" class="smart-module__tags">
              <span class="smart-tag smart-tag--melee">
                <Swords :size="12" />
                真近戰
              </span>
            </div>
        ...
        <!-- Footer: 特殊效果 (選用) -->
        <footer 
          v-if="weapon.mechanics.combat?.specialEffects?.length" 
