...
<template>
  <section class="section-card">
    ...
    <div class="equipment-grid">
      <RouterLink
        v-for="weapon in equipment.classWeapons[activeClassTab]"
        :key="weapon.name"
        :to="weapon.route"
        :class="[
          'equipment-card',
    ...
    <div class="equipment-grid equipment-grid--accessories">
      <div
        v-for="accessory in equipment.accessories"
        :key="accessory.name"
...
.equipment-card--highlight:hover {
  animation: glow-pulse-highlight 2s ease-in-out infinite;
}
