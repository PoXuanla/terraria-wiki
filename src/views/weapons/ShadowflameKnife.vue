...
import { shadowflameKnife as weaponData } from "@/data/weapons";
</script>
      ...
      <div class="strategy-grid">
        ...
        <div class="strategy-card strategy-card--ammo">
          <div class="strategy-card__header">
            <img 
              :src="weaponData.meta.bestAccessory.icon" 
              :alt="weaponData.meta.bestAccessory.name"
              class="strategy-card__item-icon"
            />
            <div class="strategy-card__header-text">
              <span class="strategy-card__title">核心飾品</span>
              <span class="strategy-card__item-name">
                {{ weaponData.meta.bestAccessory.name }}
                <small>({{ weaponData.meta.bestAccessory.nameEn }})</small>
              </span>
            </div>
          </div>
          <p class="strategy-card__desc">{{ weaponData.meta.bestAccessory.description }}</p>
        </div>
