...
import { goldenShower as weaponData } from "@/data/weapons";
</script>
      ...
      <div class="strategy-grid">
        ...
        <div class="strategy-card strategy-card--ammo">
          <div class="strategy-card__header">
            <img 
              :src="weaponData.meta.bestUseCase.icon" 
              :alt="weaponData.meta.bestUseCase.name"
              class="strategy-card__item-icon"
            />
            <div class="strategy-card__header-text">
              <span class="strategy-card__title">核心用途</span>
              <span class="strategy-card__item-name">
                {{ weaponData.meta.bestUseCase.name }}
                <small>({{ weaponData.meta.bestUseCase.nameEn }})</small>
              </span>
            </div>
          </div>
          <p class="strategy-card__desc">{{ weaponData.meta.bestUseCase.description }}</p>
        </div>
